...
const MEDS: Extracted[] = [
  ...
  {
    name: "Pan 40",
    salt: "Pantoprazole · Acid reducer",
    confidence: 86,
    dosage: "40 mg",
    frequency: "1-0-0",
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-extrabold text-ink">
              {med.name} <span className="text-small font-normal text-muted">{med.salt}</span>
            </p>
            <Badge
      ...
      <div className="mx-auto max-w-6xl p-6">
        <div className="grid gap-6 lg:grid-cols-[1.5fr_1fr]">
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-3 rounded-lg bg-accent-50 p-5">
              ...
              <div>
                ...
                <p className="text-small text-muted">
                  Review the dosage, frequency and duration below. Tap any field to correct it
                  before saving.
                </p>
              </div>
            </div>
            ...
            {MEDS.map((m) => (
              <ExtractedMedicineCard key={m.name} med={m} />
            ))}
            ...
            <div className="flex items-start gap-3 rounded-lg bg-brand-50 p-5">
              ...
              <div>
                ...
                <p className="text-small text-muted">
                  We'll add these to your medicines and set reminders.
                </p>
              </div>
            </div>
          </div>
